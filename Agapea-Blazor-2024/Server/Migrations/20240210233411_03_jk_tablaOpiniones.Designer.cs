...
namespace AgapeaBlazor2024.Server.Migrations
{
    ...
    [Migration("20240210233411_03_jk_tablaOpiniones")]
    partial class _03_jk_tablaOpiniones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Server.Models.PayPal.PedidoPayPal", b =>
                {
                    b.Property<string>("idPedidoPaypal")
                    ...
                    b.HasKey("idPedidoPaypal");

                    b.ToTable("PedidosPayPal", (string)null);
                });

            modelBuilder.Entity("AgapeaBlazor2024.Shared.Categoria", b =>
                {
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Direccion", b =>
                {
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Libro", b =>
                {
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Municipio", b =>
                {
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Opinion", b =>
                {
                    b.Property<string>("IdOpinion")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("LoginCliente")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TextoOpinion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Pedido", b =>
                {
                    b.Property<string>("IdPedido")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Provincia", b =>
                {
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Server.Models.MiClienteIdentity", b =>
                {
            ...
            modelBuilder.Entity("AgapeaBlazor2024.Shared.Pedido", b =>
                {
                    b.HasOne("AgapeaBlazor2024.Shared.Direccion", "DireccionEnvio")
                        .WithMany()
                        .HasForeignKey("DireccionEnvioIdDireccion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgapeaBlazor2024.Shared.Direccion", "DireccionFacturacion")
                        .WithMany()
